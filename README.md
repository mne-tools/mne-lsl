...
[![Brain Streaming Layer](https://raw.githubusercontent.com/fcbg-hnp-meeg/bsl/master/doc/_static/icon-with-name/icon-with-name.svg)](https://bsl-tools.github.io/)
...
Streaming Layer which provides sub-millisecond time synchroniz^ation accuracy.
...
[Fondation Campus Biotech Geneva (FCBG)](https://github.com/fcbg-hnp-meeg).
...
- pyserial, if the [Arduino to LPT converter](https://github.com/fcbg-hnp-meeg/arduino-trigger)
  is used.
