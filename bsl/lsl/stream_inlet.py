...
class StreamInlet:
    ...
    def __init__(self, sinfo, max_buflen=360, max_chunklen=0, recover=True, processing_flags=0):
    ...
    def open_stream(self, timeout=320000):
        errcode = c_int()
    ...
    def time_correction(self, timeout=320000):
        errcode = c_int()
    ...
    def pull_chunk(self, timeout=0.0, n_samples=1024, dest_obj=None):
