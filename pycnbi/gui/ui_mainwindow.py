...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_LSL = QtWidgets.QPushButton(self.groupBox_6)
        self.pushButton_LSL.setObjectName("pushButton_LSL")
        self.horizontalLayout_6.addWidget(self.pushButton_LSL)
        self.comboBox_LSL = QtWidgets.QComboBox(self.groupBox_6)
        ...
        self.pushButton_StartViewer = QtWidgets.QPushButton(self.groupBox_5)
        self.pushButton_StartViewer.setObjectName("pushButton_StartViewer")
        self.horizontalLayout_4.addWidget(self.pushButton_StartViewer)
        self.pushButton_StopViewer = QtWidgets.QPushButton(self.groupBox_5)
        self.pushButton_StopViewer.setObjectName("pushButton_StopViewer")
        self.horizontalLayout_4.addWidget(self.pushButton_StopViewer)
        ...
        self.scrollAreaWidgetContents_Basics.setGeometry(QtCore.QRect(0, 0, 532, 275))
        ...
        self.scrollAreaWidgetContents_Adv.setGeometry(QtCore.QRect(0, 0, 532, 275))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_6.setTitle(_translate("MainWindow", "LSL"))
        self.pushButton_LSL.setText(_translate("MainWindow", "Search"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Viewer"))
        self.pushButton_StartViewer.setText(_translate("MainWindow", "Start"))
        self.pushButton_StopViewer.setText(_translate("MainWindow", "Stop"))
