...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollArea_Basics = QtWidgets.QScrollArea(self.BasicsParams)
        self.scrollArea_Basics.setWidgetResizable(True)
        self.scrollArea_Basics.setObjectName("scrollArea_Basics")
        self.scrollAreaWidgetContents_Basics = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_Basics.setGeometry(QtCore.QRect(0, 0, 228, 90))
        self.scrollAreaWidgetContents_Basics.setObjectName("scrollAreaWidgetContents_Basics")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_Basics)
        self.verticalLayout_8.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout_8.setSpacing(6)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.verticalLayout_Basic = QtWidgets.QVBoxLayout()
        self.verticalLayout_Basic.setSpacing(6)
        self.verticalLayout_Basic.setObjectName("verticalLayout_Basic")
        self.verticalLayout_8.addLayout(self.verticalLayout_Basic)
        self.scrollArea_Basics.setWidget(self.scrollAreaWidgetContents_Basics)
        self.verticalLayout_3.addWidget(self.scrollArea_Basics)
        ...
        self.scrollArea_Adv = QtWidgets.QScrollArea(self.AdvancedParams)
        self.scrollArea_Adv.setWidgetResizable(True)
        self.scrollArea_Adv.setObjectName("scrollArea_Adv")
        self.scrollAreaWidgetContents_2_Adv = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2_Adv.setGeometry(QtCore.QRect(0, 0, 228, 90))
        self.scrollAreaWidgetContents_2_Adv.setObjectName("scrollAreaWidgetContents_2_Adv")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_2_Adv)
        self.verticalLayout_11.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout_11.setSpacing(6)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.verticalLayout_Adv = QtWidgets.QVBoxLayout()
        self.verticalLayout_Adv.setSpacing(6)
        self.verticalLayout_Adv.setObjectName("verticalLayout_Adv")
        self.verticalLayout_11.addLayout(self.verticalLayout_Adv)
        self.scrollArea_Adv.setWidget(self.scrollAreaWidgetContents_2_Adv)
        self.verticalLayout_5.addWidget(self.scrollArea_Adv)
        ...
        self.horizontalLayout_4.addWidget(self.textEdit_terminal)
        self.verticalLayout_6.addLayout(self.horizontalLayout_4)
        self.verticalLayout_2.addWidget(self.groupBox_4)
        MainWindow.setCentralWidget(self.centralWidget)
        self.menuBar = QtWidgets.QMenuBar(MainWindow)
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 294, 20))
