...
def get_feature_scores(featfile, channels=None, freq_ranges=None, matfile=None):
    """
    Parse feature importance scores generated by trainer_mi.py and
    ...
    ----------
    featfile : str
        The path to the feature importance distribution file computed by Random Forests.
        Each line contains 3 columns separated by tab: Score Channel Frequency
        e.g. 66.6 \t Cz \t 18
    channels : list
        List of channel names. If None, all channels in featfile will be used.
    freq_ranges : list
        Per-band frequency range. dict:{band_name:[fq_low, fq_high]} fq_high is
        included in the range. If None, predefined bands will be used.
    matfile : str
        The path to the output .mat file. If None, not exported.

    Output
    ------
    data : dict
        The features importance scores. {band_name:percentage}
...
def print_feature_scores(data, num_cols=8):
    ...
    ----------
    data : dict
        The The features importance scores generated by get_feature_scores
    num_cols : int
        The number of columns to display the results
    """
...
def feature_info(featfile, channels=None, freq_ranges=None, matfile=None):
    ...
    featfile : str
        The path to the feature importance distribution file computed by Random Forests (good_features.txt).
        Each line contains 3 columns separated by tab: Score Channel Frequency
        e.g. 66.6 \t Cz \t 18
    channels : list
        List of channel names. If None, all channels in featfile will be used.
...
def config_run(featfile=None):
    ...
    featfile : str
        ...
        Each line contains 3 columns separated by tab: Score Channel Frequency
        e.g. 66.6 \t Cz \t 18
        If None, it will look in the folder for good_features.txt
    """
