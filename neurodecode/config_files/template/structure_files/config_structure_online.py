...
class Basic:
    ...
    DECODER_FILE and TRIGGER_FILE               :   Can be automatically deduced from subject folder 
    DIRECTIONS                                  :   Feedback directions (Assign one direction for each decoder class)
