"""
NeuroDecode global configurations
...
import os
NEUROD_ROOT = os.path.dirname(os.path.realpath(__file__))
...
CAP = {
    ...
    'ANTNEURO_MI15': ['TRIGGER', 'Fz', 'FC1', 'FC2', 'C3', 'Cz', 'C4', 'CP1', 'CP2', 'FC3','FCz', 'FC4', 'C1', 'C2', 'CP3', 'CP4'],
    'ANTNEURO_MI15_INFO': ['stim'] + ['eeg'] * 15,
    
    'ANTNEURO_64': ['TRIGGER', 'Fp1', 'Fpz', 'Fp2', 'F7', 'F3', 'Fz', 'F4', 'F8', 'FC5', 'FC1', 'FC2', 'FC6', 'T7', 'C3', 'Cz', 'C4', 'T8', 'CP5', 'CP1', 'CP2', 'CP6', 'P7', 'P3', 'Pz', 'P4', 'P8', 'POz', 'O1', 'O2', 'AF7', 'AF3', 'AF4', 'AF8', 'F5', 'F1', 'F2', 'F6', 'FC3', 'FCz', 'FC4', 'C5', 'C1', 'C2', 'C6', 'CP3', 'CP4', 'P5', 'P1', 'P2', 'P6', 'PO5', 'PO3', 'PO4', 'PO6', 'FT7', 'FT8', 'TP7', 'TP8', 'PO7', 'PO8', 'Oz'],
    'ANTNEURO_64_INFO' : ['stim'] + ['eeg'] * 
    
    'DSI_24': ['TRIGGER', 'Fp1', 'Fp2', 'Fz', 'F3', 'F4', 'F7', 'F8', 'Cz', 'C3', 'C4', 'T3', 'T4', 'T5', 'T6', 'Pz', 'P3', 'P4', 'O1', 'O2', 'A1', 'A2', 'X1', 'X2', 'X3']
    'DSI_24_INFO': 
}
